...
@HiltViewModel
class WallPaperViewModel @Inject constructor(private val wallpaperRepository: WallpaperRepository): ViewModel() {
    ...
    fun fetchWallPapers() {
        viewModelScope.launch(Dispatchers.IO) {
            wallpaperRepository.getWallpapers().collect { resource ->
                when (resource) {
                    is Resource.Success -> {
